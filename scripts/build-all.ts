...
import { fetchMospiCPI } from "./fetch-mospi.js";
...
async function buildAll() {
  ...
  // Step 8: India MOSPI CPI
  console.log("--- Step 8/9: India MOSPI CPI ---");
  await fetchMospiCPI();
  console.log();

  // Step 9: Country metadata manifest
  console.log("--- Step 9/9: Country Metadata ---");
